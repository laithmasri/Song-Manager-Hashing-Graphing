...
public class DLListTest extends TestCase {
    ...
    public void testRemoveIndex() {
        list.add("A");
        list.add("B");
        assertEquals("B", list.removeIndex(1));
        assertEquals(1, list.size());
        list.add("B");
        assertEquals("A", list.removeIndex(0));
        assertEquals(1, list.size());
    }
    ...
    public void testIterator()
    {
        ...
        newList.add("element0");
        newList.add("element1");
        assertTrue(newList.contains("element0"));
        assertEquals("element0", newList.get(0));
        assertEquals(1, newList.lastIndexOf("element1"));
        System.out.println(newList.toString());
        assertTrue(iter.hasNext());
        assertEquals("element0", iter.next());
        assertTrue(iter.hasNext());
